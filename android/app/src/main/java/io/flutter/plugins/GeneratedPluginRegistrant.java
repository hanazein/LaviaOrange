...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.qr.scan.Scanner.ScannerPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin simple_scanner, com.qr.scan.Scanner.ScannerPlugin", e);
    }
    try {
